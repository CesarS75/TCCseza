...
<body>
    <?php
        ...
        echo "<form name='cadastro' method='post' action=''>";
            echo "<table align='center'>";
                ...
                echo "<tr>";
                    ...
                    echo "<td> <input type='text' name='DescricaoCat' value='$DescricaoCat' size='30' maxlength='250' required>";
                echo "</tr>";
        ...
        echo "<script>location.href='pesquisarCAT.php?pesquisar=$id_categoria';</script>";
        }
