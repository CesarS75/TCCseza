        ...
        echo "<form name='cadastro' method='post' action=''>";
            echo "<table align='center'>";
                ...
                echo "<tr>";
                    ...
                    echo "<td> <input type='text' name='data' value='$data' size='30' maxlength='30' required>";
                echo "</tr>";

                echo "<tr>";
                    echo "<td> <label for='valor'>Valor: </label>";
                    echo "<td> <input type='text' name='valor' value='$valor' size='14' maxlength='14' required>";
                echo "</tr>";
